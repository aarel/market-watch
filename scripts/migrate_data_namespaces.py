...
def migrate_analytics_to_simulation():
    ...
    if equity_src.exists():
        ...
        print("  ✓ Moved equity.jsonl → data/simulation/")
...
def migrate_config_to_simulation():
    ...
    print("  ✓ Copied config_state.json → data/simulation/config.json")
    print("  ℹ Original config_state.json kept for reference (will be removed in Week 2)")
